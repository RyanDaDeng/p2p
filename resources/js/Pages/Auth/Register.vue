    ...
    <P2PAppLayout :hideNavigation="true" :show-mobile-bottom-nav="false">
        ...
        <div class="absolute inset-0 crypto-bg">
            ...
            <div class="absolute inset-0 overflow-hidden pointer-events-none">
                <!-- Bitcoin -->
                <div class="absolute top-20 right-10 opacity-20" style="transform: rotate(18deg);">
                    <BitcoinIcon class="w-16 h-16 md:w-20 md:h-20" />
                </div>

                <!-- Ethereum -->
                <div class="absolute bottom-32 left-20 opacity-20" style="transform: rotate(-30deg);">
                    <EthereumIcon class="w-20 h-20 md:w-24 md:h-24" />
                </div>

                <!-- USDT -->
                <div class="absolute top-40 left-32 opacity-20" style="transform: rotate(10deg);">
                    <UsdtIcon class="w-24 h-24 md:w-28 md:h-28" />
                </div>

                <!-- BNB -->
                <div class="absolute top-60 right-40 opacity-20" style="transform: rotate(-20deg);">
                    <BnbIcon class="w-18 h-18 md:w-22 md:h-22" />
                </div>

                <!-- USDC -->
                <div class="absolute bottom-1/2 right-10 opacity-20" style="transform: rotate(28deg);">
                    <UsdcIcon class="w-14 h-14 md:w-16 md:h-16" />
                </div>

                <!-- Tron -->
                <div class="absolute bottom-1/4 left-1/3 opacity-20" style="transform: rotate(-12deg);">
        ...
        <div class="relative z-10 w-full max-w-md px-4">
            <div class="bg-white dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-slate-800 shadow-2xl p-4 sm:p-6">
                <!-- Title -->
                <h2 class="text-2xl font-bold text-center text-gray-900 dark:text-white mb-6">注册</h2>

                <!-- Register Form -->
                <form @submit.prevent="submit">
                    <!-- Name -->
                    <div class="mb-3">
                        <label for="name" class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-slate-300 mb-1.5">
                            用户名
                        </label>
                        <div class="relative">
                    ...
                    <!-- Email -->
                    <div class="mb-3">
                        <label for="email" class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-slate-300 mb-1.5">
                            邮箱地址
                        </label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-2.5 flex items-center pointer-events-none">
                    ...
                    <!-- Password -->
                    <div class="mb-3">
                        <label for="password" class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-slate-300 mb-1.5">
                            密码
                        </label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-2.5 flex items-center pointer-events-none">
                            ...
                            <input
                                ...
                                class="w-full pl-9 pr-9 py-2 sm:py-2.5 text-sm bg-gray-50 dark:bg-slate-800/50 border border-gray-300 dark:border-slate-700 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200"
                                placeholder="至少8位字符"
                            />
                            <button
                                type="button"
                    ...
                    <!-- Confirm Password -->
                    <div class="mb-3">
                        <label for="password_confirmation" class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-slate-300 mb-1.5">
                            确认密码
                        </label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-2.5 flex items-center pointer-events-none">
                            ...
                            <button
                                ...
                                class="absolute inset-y-0 right-0 pr-3 flex items-center"
                            >
                                <svg v-if="!showPasswordConfirmation" class="h-5 w-5 text-slate-500 hover:text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                </svg>
                                <svg v-else class="h-5 w-5 text-gray-400 dark:text-slate-500 hover:text-gray-600 dark:hover:text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mb-4">
                        <label class="flex items-start cursor-pointer">
                            <input
                                ...
                                type="checkbox"
                                required
                                class="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-0.5 text-emerald-500 bg-white dark:bg-slate-800 border-gray-300 dark:border-slate-600 rounded focus:ring-emerald-500 focus:ring-2 cursor-pointer"
                            />
                            <span class="ml-2 text-xs sm:text-sm text-gray-600 dark:text-slate-400">
                                我同意
                                <a href="/terms" class="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300">服务条款</a>
                                和
                                <a href="/privacy" class="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300">隐私政策</a>
                            </span>
                        </label>
                        <div v-if="form.errors.terms" class="mt-2 text-sm text-red-400">
                            {{ form.errors.terms }}
                        </div>
                    </div>
                ...
                <div class="relative my-4">
                    ...
                    <div class="relative flex justify-center text-xs sm:text-sm">
                        <span class="px-2 bg-white dark:bg-slate-900/80 text-gray-500 dark:text-slate-500">已有账户？</span>
                    </div>
                </div>
